...
namespace Lesson_14
{
    public class GrenadeDamageDealer : MonoBehaviour
    {
        ...
        [SerializeField] private ThrowGranate _grenadeAction;
        ...
        private void GrenadeSpawnedHandler(Granate grenade)
        {
            grenade.OnExplosionHit += colliders => GrenadeExplosionHitHandler(grenade, colliders);
        }

        private void GrenadeExplosionHitHandler(Granate grenade, Collider[] colliders)
        {
            int hitCount = 0;
